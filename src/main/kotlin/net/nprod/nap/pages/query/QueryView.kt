...
/**
 * View for the SPARQL query page
 * This renders the query interface with CodeMirror editor and results display
 */
object QueryView {
    /**
     * Render the query page HTML
     * @param data The view data containing title
     * @return HTML string of the query page
     */
    fun render(data: QueryViewData): String {
        return createHTMLDocument().html {
            head {
                genericHead(title = data.title) {
